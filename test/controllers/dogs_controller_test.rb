...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { last_walked_date: @dog.last_walked_date, name: @dog.name } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { last_walked_date: @dog.last_walked_date, name: @dog.name } }
